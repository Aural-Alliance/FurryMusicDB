        ...
        <form @submit.prevent="submit">
            <div class="row g-2 mb-3">
                <form-group-field id="form_edit_name" class="col-md-6"
                                  :field="v$.name"
                                  label="Album Name"></form-group-field>
            </div>
            <div class="buttons">
...
const isEditMode = 'album_id' in params;

const apiUrl = computed(() => {
    return (isEditMode)
        ? `/profile/artist/${params.artist_id}/album/${params.album_id}`
        : `/profile/artist/${params.artist_id}/albums`;
});
